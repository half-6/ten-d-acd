...
- java -jar backend\target\com.tend.acd.backend-0.0.8-SNAPSHOT.jar
...
``
java -jar com.tend.acd.backend-0.0.8-SNAPSHOT.jar --postgreSQL.connection=jdbc:postgresql://127.0.0.1:5432/tend?user=<user>&password=<password>
``
...
java -jar com.tend.acd.backend-0.0.8-SNAPSHOT.jar --spring.profiles.active=env
``
