...
ssh -i D:\codes\mykey\linkfuture.ppk root@192.168.201.110 "cd /mnt/tend/; sudo docker-compose build web; cd /mnt/tend/tend; sudo docker-compose down; sudo docker-compose up -d"